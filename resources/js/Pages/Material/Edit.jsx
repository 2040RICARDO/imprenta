...
export default function MaterialEdit({errors,categorias,material,permisos }) {
    ...
    const { data, setData, put } = useForm({
        ...
        categoriaId: material.categoriaproducto_id,

    });

    function handleSubmit(e) {
        e.preventDefault();
        put(route("material.update",{ id: material.id }));
    }
