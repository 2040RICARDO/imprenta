...
export default function EditCreate({errors,permissions,role,permisosss,flash,permisos }) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        put(route("role.update",{ id: role.id }));
    }
    ...
    //////////////AÑADIR PERMISOS/////////
    const handleCheckboxChange = (e, roleName) => {
       ...
       console.log(data.permisos)
        ...
        setData(prevData => ({
            ...prevData,
            permisos: isChecked
                ? [...prevData.permisos, roleName]
                : prevData.permisos.filter(id => id !== roleName),
        }));
    };
    //////////////AÑADIR PERMISOS/////////
                                    ...
                                    {permissions.map(per => (
                                        <tr key={per.id}>
                                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                <input type="checkbox"  checked={data.permisos.includes(per.name)}onChange={(e) => handleCheckboxChange(e, per.name)}   />
                                            </td>
